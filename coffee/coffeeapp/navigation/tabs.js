...
const CustomTabBarButton = ({containerStyle, children, isFloat, onPress}) => {
  if (isFloat) {
    return (
      <View
        style={{
    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => <CustomTabBarButton {...props} containerStyle={{marginRight:6}} />,
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarButton: props => <CustomTabBarButton {...props} containerStyle={{marginLeft:6}} />,
        }}
      />
      <Tab.Screen
        name="Profile"
