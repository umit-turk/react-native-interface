...
const CryptoDetail = ({route, navigation}) => {
  ...
  const [charOptions, setCharOptions] = useState(dummyData.chartOptions);
  const [selectedOption, setSelectedOption] = useState(charOptions[0]);
            ...
            <View
              ...
              <View
                ...
                <VictoryChart
                  ...
                  />
                  {/* gafik üzerindeki noktalar için */}
                  <VictoryScatter
                    data={selectedCurrency?.chartData}
                    size={7}
                    style={{
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{textAlign: 'right', color: COLORS.gray, ...FONTS.h3}}>
